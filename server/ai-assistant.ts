/**
 * Apex CRM AI Assistant — Smart self-contained assistant with optional LLM enhancement.
 *
...
function getFeatureExplanation(topic: string): string {
  ...
  if (/compan/.test(t)) return "🏢 **Companies** are the primary entities in Apex CRM. Every contact belongs to a company. You can track industry, website, phone, address, lead status, and notes. The Companies page shows aggregate metrics per company including contact count, open deals, and pipeline value.";
