...
<div class="container">
  ...
  <div class="body">
    ...
    <div class="highlight">
      <p><strong>Did you know?</strong> The average new freight broker spends 60% of their first year on administrative tasks instead of building relationships and moving loads. AXIOM CRM was built specifically to flip that ratio.</p>
    </div>

    <h2>How AXIOM CRM Helps New Brokers Grow</h2>
    <div class="features">
      <div class="feature">
    ...
    <div class="cta-section">
      ...
      <br/><br/>
      <p style="color: #cbd5e1; margin-bottom: 24px;">We're so confident AXIOM CRM will transform your brokerage that we're offering you a full 2-month trial with zero obligation. Get access to every feature, every tool, every advantage.</p>
  ...
  <div class="footer">
    <p>AXIOM CRM — Built for Transportation Brokers</p>
  ...
  <div class="body">
    ...
    <table class="price-table">
      ...
      <tbody>
        ...
        <tr>
          <td style="color: #34d399; font-weight: 700;">AXIOM CRM</td>
    ...
    <p>AXIOM CRM was built by people who understand the freight brokerage business. We're not a generic CRM with a "transportation add-on" — every feature was designed for how brokers actually work.</p>
    ...
    <p>Unlike enterprise CRMs that take weeks to set up and require expensive consultants, AXIOM CRM is ready to go the moment you sign up:</p>
    <div class="solutions">
      <div class="solution">
    ...
    <div class="cta-section">
      <a href="#" class="cta-btn">Join AXIOM CRM Free →</a>
      <br/><br/>
      <a href="#" class="cta-secondary">Schedule a Quick Demo Instead</a>
    </div>
  </div>
  <div class="footer">
    <p>AXIOM CRM — Built by Brokers, for Brokers</p>
    <p>Questions? Reply to this email or visit our <a href="#">Help Center</a></p>
    <p style="margin-top: 16px;"><a href="#">Unsubscribe</a> · <a href="#">Privacy Policy</a></p>
  </div>
</div>
