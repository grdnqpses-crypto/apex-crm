...
const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    description: "Configure your company settings, branding, SMTP accounts, and integrations to make AXIOM CRM truly yours.",
  ...
  },
  {
    ...
    description: "Congratulations! You've completed the AXIOM CRM onboarding. You're ready to start closing deals and growing your business.",
...
// ─── Onboarding Context ───
const STORAGE_KEY = "axiom-onboarding";
        ...
        <Card className="shadow-2xl border-slate-200 overflow-hidden">
          ...
          <CardContent className="p-5">
            ...
            <h3 className="text-lg font-semibold text-slate-900 mb-2">
              {/* White-label: replace "AXIOM CRM" with company name for non-admin roles */}
