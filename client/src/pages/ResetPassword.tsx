    ...
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <span className="text-xl font-black text-white tracking-tight">AXIOM CRM</span>
        </div>
          ...
          {done ? (
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-sm text-white/40">Choose a strong password for your AXIOM CRM account.</p>
              </div>
        ...
        <p className="text-center text-xs text-white/20 mt-6">
          &copy; {new Date().getFullYear()} AXIOM CRM. All rights reserved.
        </p>
      </div>
    </div>
  );
