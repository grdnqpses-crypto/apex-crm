...
const SECTION_MIN_LEVEL: Record<string, number> = {
  ...
  billingManage: 90, // AXIOM Owner and Developer only (change plan, update payment method)
};
    ...
    features: [
      {
        ...
        what: "Team is your user management panel — where you create, edit, and assign roles to every person in your organization. The role hierarchy is: Developer → AXIOM Owner → Company Admin → Sales Manager / Office Manager → Account Manager / Coordinator.",
    ...
    features: [
      {
        id: "workflows",
        title: "Workflows",
        what: "The automation engine of AXIOM CRM. A Workflow is a set of rules: When [trigger event] happens, and [conditions] are met, then [actions] execute. Workflows run 24/7 without human intervention.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        what: "A conversational AI assistant fully versed in every aspect of AXIOM CRM. Ask it anything — 'How do I set up a workflow?', 'Add a contact named John Smith at Acme Corp', 'Show me my hot leads', 'Create a campaign for my top 50 prospects'. It answers questions and executes CRM tasks directly.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        what: "Every user in AXIOM CRM is assigned a role that determines which sections of the CRM they can access by default. The hierarchy is: Developer → AXIOM Owner → Company Admin → Sales Manager / Office Manager → Account Manager / Coordinator.",
      ...
      },
      {
        ...
        title: "Integrations",
        what: "Connect external services to AXIOM CRM: Apollo.io (lead sourcing), NeverBounce (email verification), SendGrid (additional sending capacity), PhantomBuster (LinkedIn automation), and Google AI Studio (enhanced AI features).",
        why: "No single tool does everything. Integrations let AXIOM CRM serve as the hub that connects your entire sales technology stack.",
        ...
        automation: "Connected integrations feed data automatically into AXIOM CRM. Apollo.io sends new prospects to the Paradigm Engine. NeverBounce verifies emails before they are added to the system.",
      ...
      },
      {
        ...
        outcome: "Company Admins have instant, self-service access to the full payment history without needing to contact the AXIOM Owner or log into Stripe. This eliminates a recurring administrative bottleneck and ensures accounting teams always have the records they need.",
      },
      {
        ...
        how: "The banner appears automatically — no configuration needed. When Stripe reports a subscription status of 'past_due' or 'unpaid', the banner renders above the main content area on every page. Click 'Resolve Payment' to go directly to Billing & Plans, where an AXIOM Owner can update the payment method via the Stripe portal. The banner disappears automatically once the payment is resolved and the subscription status returns to 'active'.",
        automation: "Stripe webhooks update the subscription status in real time. The banner checks the status on every page load for Company Admin, AXIOM Owner, and Developer roles. When the payment is resolved, the webhook fires, the status updates, and the banner is removed without any manual action.",
      ...
      },
      {
        ...
        why: "Email deliverability is the foundation of every campaign, sequence, and outreach in AXIOM CRM. Without properly configured DNS records, your emails land in spam — or worse, get your domain blacklisted. Most CRMs leave users to figure this out alone. AXIOM CRM guides you through the entire process, regardless of your technical background.",
        ...
        automation: "Once your domain passes verification, AXIOM CRM automatically enrolls it in the Email Warmup module — a graduated sending schedule that builds your domain's sender reputation over 30 days. The warmup schedule runs in the background without any manual intervention. DNS record status is re-checked automatically every 24 hours and you are notified if any records degrade.",
      ...
      },
      {
        ...
        how: "Company Admins: Navigate to Billing to view the current plan, next billing date, and payment history. All controls are read-only. AXIOM Owners and Developers: All of the above, plus the ability to click Upgrade to compare plans and initiate a Stripe checkout, or click Manage Billing to open the Stripe portal for payment method updates, invoice downloads, or cancellation.",
        automation: "Subscription status is checked automatically on every login. If a payment fails, the system sends automated reminder emails to the AXIOM Owner with a direct link to update the payment method. Subscription changes take effect immediately and are reflected in the billing history for all authorized viewers.",
      ...
      <div className="border-b bg-gradient-to-br from-background via-background to-primary/5 px-6 py-10">
        <div className="max-w-4xl mx-auto">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-2xl font-black tracking-tight">AXIOM CRM Bible</h1>
          ...
          {!search && (
            <section className="rounded-2xl border bg-gradient-to-br from-primary/5 via-background to-purple-500/5 p-6">
              ...
              <blockquote className="mt-6 border-l-4 border-primary pl-4 text-sm text-muted-foreground italic">
                "Every feature in AXIOM CRM exists to answer one question — <strong className="text-foreground not-italic">what is the next best action to take, for this specific person, right now?</strong> The system answers that question automatically, at scale, for every prospect and customer in your database, simultaneously. Your job is to execute the actions the system surfaces. The machine does the thinking. You do the talking. Together, you close more deals."
              </blockquote>
            </section>
          )}
        </main>
