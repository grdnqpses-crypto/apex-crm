  ...
  return (
    <div ref={ref} className="rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-5 shadow-2xl border border-gray-700/50">
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-[10px] text-gray-500 ml-2 font-mono">AXIOM AI Assistant</span>
      </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-500 to-rose-600 text-white">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6 py-20 text-center">
          ...
          <h1 className="text-5xl md:text-7xl font-black tracking-tight leading-[1.1] mb-6">
            Meet <span className="bg-clip-text text-transparent bg-gradient-to-r from-white to-amber-100">AXIOM CRM</span>
          </h1>
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              The AXIOM AI Assistant understands natural language and executes CRM actions instantly. 
      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-xl mx-auto">
              From first contact to closed deal to delivered load — AXIOM CRM handles the entire lifecycle.
            </p>
          </div>
        ...
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-3">
            ...
            <div className="text-left">
              <p className="text-sm font-semibold text-white">The AXIOM Vision</p>
      ...
      <section className="bg-gray-900 text-white py-8">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <div className="flex items-center justify-center gap-2 mb-3">
            ...
            <span className="text-lg font-bold">AXIOM CRM</span>
          </div>
