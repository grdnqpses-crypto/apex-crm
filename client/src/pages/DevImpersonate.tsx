      ...
      <div className="flex items-center justify-between">
        ...
        {skinId !== "apex" && (
          <div className="flex items-center gap-2">
            ...
            <Button variant="outline" size="sm" className="rounded-lg gap-1.5" onClick={() => setSkin("apex")}>
              <RotateCcw className="h-3.5 w-3.5" /> Reset to Apex
            </Button>
          </div>
        )}
      </div>
                ...
                <Card>
                  <CardHeader>
                    <div className="flex items-center justify-between">
                      ...
                      <Button variant="ghost" size="icon" className="h-8 w-8" onClick={() => { setSelectedUserId(null); setSkin("apex"); }}>
                        <X className="h-4 w-4" />
                      </Button>
                    </div>
                  </CardHeader>
