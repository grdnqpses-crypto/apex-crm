...
const PRICING_TIERS = [
  ...
  },
  {
    ...
    price: 1497,
    period: "month",
    description: "Dedicated infrastructure. Custom AI. Resell AXIOM as your own.",
    highlight: false,
    badge: "Enterprise",
...
const TESTIMONIALS = [
  { name: "Sarah Chen", role: "Sales Manager, TechCorp", quote: "AXIOM CRM increased our close rate by 34% in the first quarter. The AI prospecting alone is worth the investment." },
    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-8 text-slate-400 text-sm">
            ...
            <div className="text-center">
              ...
              <div className="text-amber-300">AXIOM CRM</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-slate-900 to-slate-800">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-slate-300 mb-8">
            Join hundreds of companies already using AXIOM CRM to close more deals, faster.
          </p>
          <Button size="lg" className="h-14 px-8 text-lg bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-600 hover:to-orange-600"
            onClick={() => { setStep("register"); window.scrollTo(0, 0); }}>
      ...
      <footer className="bg-slate-900 border-t border-slate-800 py-8">
        <div className="max-w-6xl mx-auto px-6 text-center text-sm text-slate-500">
          <p>&copy; {new Date().getFullYear()} AXIOM CRM. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
