...
const PRICING_TIERS = [
  {
    ...
    features: [
      "1 user included (add up to 4 @ $25/user/mo)",
      "5,000 contacts",
    ...
    limits: "1 user · 5,000 contacts · add-ons available",
  },
  {
    ...
    price: 149,
    period: "month",
    description: "Full automation and BNB Engine for teams ready to scale.",
    highlight: false,
    savings: "70% less than HubSpot Pro",
    features: [
      "5 users included (add up to 10 @ $25/user/mo)",
      "25,000 contacts",
      "Marketing automation + lead scoring",
      "BNB Paradigm Engine™ — 500 prospects/month",
      "Ghost Mode sequences (3 active)",
      "AR/AP automation + full Shipping module",
      "Deliverability suite",
    ],
    limits: "5 users · 25,000 contacts · up to 15 total",
  },
  {
    ...
    price: 374,
    period: "month",
    description: "Enterprise deliverability and full AI at mid-market price.",
    highlight: true,
    badge: "Most Popular",
    savings: "75% less than HubSpot Pro",
    features: [
      "15 users included (add up to 10 @ $25/user/mo)",
      "100,000 contacts",
      "260 SMTP rotation engine",
      "Compliance Fortress™ — GDPR + CCPA + CAN-SPAM",
      "BNB Paradigm Engine™ Full — unlimited prospects",
      "Voice Agent (200 calls/mo) + DocScan (50/mo)",
      "Win Probability Engine",
    ],
    limits: "15 users · 100,000 contacts · up to 25 total",
  },
  {
    name: "Fortune",
    slug: "fortune",
    price: 524,
    period: "month",
    description: "White-labeling, Revenue Autopilot, and unlimited AI.",
    highlight: false,
    savings: "83% less than HubSpot Enterprise",
    features: [
      "25 users included (add up to 15 @ $25/user/mo)",
      "250,000 contacts",
      "All Fortune Foundation features",
      "Voice Agent — unlimited + DocScan — unlimited",
      "Revenue Autopilot + Apex Autopilot",
      "White-labeling — full platform branding",
      "Dedicated account manager + 99.5% SLA",
    ],
    limits: "25 users · 250,000 contacts · up to 40 total",
  },
  {
    name: "Fortune Plus",
    slug: "fortune_plus",
    ...
    features: [
      ...
      "Custom AI training — full, unlimited",
      "99.9% SLA + Priority 24/7 white-glove support",
    ],
    limits: "50 users · Unlimited contacts",
  },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-8 text-slate-400 text-sm">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-400">$74–$1,124/mo</div>
