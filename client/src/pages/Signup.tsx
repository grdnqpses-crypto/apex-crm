...
const PRICING_TIERS = [
  {
    ...
    limits: "5 users · 10,000 contacts · 5 GB storage",
  },
  {
    name: "Growth",
    slug: "professional",
    ...
    limits: "15 users · 100,000 contacts · 25 GB storage",
  },
  {
    name: "Enterprise",
    slug: "enterprise",
    ...
    limits: "25 users · Unlimited contacts · 100 GB storage",
  },
];
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-24 text-center">
          ...
          <div className="flex items-center justify-center gap-8 text-slate-400 text-sm">
            ...
            <div className="text-center">
              <div className="text-3xl font-bold text-amber-400">$197/mo</div>
