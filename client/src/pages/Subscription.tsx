...
const PLANS = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: "AXIOM Autopilot™", type: "excluded" },
  ...
  },
  {
    ...
    features: [
      ...
      { text: "AXIOM Autopilot™ (fully autonomous sales)", type: "premium", highlight: true },
      ...
      { text: "SaaS Mode — resell AXIOM as your own product", type: "premium", highlight: true },
      ...
      <Card className="border-green-200 bg-green-50/50">
        <CardContent className="p-5">
          <h3 className="font-semibold mb-3 flex items-center gap-2">
            ...
            How AXIOM Compares — Same Team, More Features, Fraction of the Cost
          </h3>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-green-200">
                  ...
                  <th className="text-right py-2 px-4 font-medium text-green-700 font-bold">AXIOM CRM</th>
          ...
          <p className="text-xs text-muted-foreground mt-3">
            * GHL + Instantly combined. AXIOM includes features competitors charge extra for or don't offer at all: 260 SMTP Rotation Engine, Compliance Fortress™, BNB Paradigm Engine™, AR/AP module, Shipping & Receiving, Voice Agent, Revenue Autopilot™, AXIOM Autopilot™, and one-click migration — all included at qualifying tiers.
          </p>
        </CardContent>
      </Card>
