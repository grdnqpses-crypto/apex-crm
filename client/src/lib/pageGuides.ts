// Centralized contextual help content for every page in AXIOM CRM
...
export const pageGuides: Record<string, PageGuideData> = {
  ...
  apiKeys: {
    ...
    sections: [
      { icon: "purpose", title: "What This Page Does", content: "API Keys let you connect external systems to your CRM programmatically. Any software that needs to read or write CRM data — your website, custom tools, third-party integrations — uses an API key to authenticate. This is how you extend AXIOM CRM's capabilities." },
